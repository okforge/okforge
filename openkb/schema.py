...
def get_agents_md(wiki_dir: Path) -> str:
    ...
    if agents_file.exists():
        # Strip the OKF frontmatter: prompts want the schema text, not
        # bundle metadata.
        return frontmatter.body(agents_file.read_text(encoding="utf-8"))
    return frontmatter.body(AGENTS_MD)
