...
targets route through ``okforge.agent.skill_runner.run_skill`` under the
...
from okforge.deck.creator import DEFAULT_DECK_SKILL, run_deck_create
from okforge.deck.validator import ValidationResult as DeckValidationResult
from okforge.skill import skill_dir
from okforge.skill.creator import run_skill_create
    ...
    def __init__(
        ...
        *,
        ...
        skill_name: For ``target_type="deck"``, which deck skill to use.
            Defaults to :data:`okforge.deck.creator.DEFAULT_DECK_SKILL`
