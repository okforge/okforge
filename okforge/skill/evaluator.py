...
from okforge.config import get_extra_headers, get_timeout_extra_args, state_dir
from okforge.skill import extract_body, extract_frontmatter
...
def save_eval_set(
    ...
    """Persist an eval set to ``<kb>/.okforge/eval-sets/<skill_name>.json``."""
    out_dir = state_dir(kb_dir) / "eval-sets"
