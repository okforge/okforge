...
def list_wiki_dir(directory: str, wiki_root: str) -> str:
    ...
    Thin wrapper around :func:`okforge.agent.tools.list_wiki_files`.
...
def read_wiki_file_for_skill(path: str, wiki_root: str) -> str:
    ...
    Thin wrapper around :func:`okforge.agent.tools.read_wiki_file`.
...
def get_skill_page_content(doc_name: str, pages: str, wiki_root: str) -> str:
    ...
    Thin pass-through to :func:`okforge.agent.tools.get_wiki_page_content` so
...
def read_skill_image(path: str, wiki_root: str) -> dict:
    ...
    Thin pass-through to :func:`okforge.agent.tools.read_wiki_image`. The
