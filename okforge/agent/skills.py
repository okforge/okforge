"""Skill discovery for okforge chat — Anthropic-style SKILL.md format.
...
Skill search roots (first hit wins on name collision):
  ...
  2. ``~/.config/okforge/skills/`` — user-global skills
...
#   - wheel install:  force-included at ``okforge/_skills/``
