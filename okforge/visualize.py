...
from okforge.lint import _extract_wikilinks, _normalize_target
from okforge.schema import PAGE_CONTENT_DIRS
...
def render_html(graph: dict) -> str:
    ...
    template = (
        resources.files("okforge").joinpath("templates/graph.html").read_text(encoding="utf-8")
    )
