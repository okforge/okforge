...
plus the **real artifact** okforge produced for it (generated, not hand-written).
...
generated by running okforge over a single document —
...
New to okforge? Read [`configuration/`](configuration/) first, then
[`commands/`](commands/).
